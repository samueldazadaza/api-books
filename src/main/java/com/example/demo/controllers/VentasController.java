...
public class VentasController {
    ...
    // @GetMapping("/ventas/vendedor") //DUDA (CONSULTA CON UNA LLAVE FORÁNEA EN
    // ESTA TABLA DE VENTAS)
    // public ArrayList<VentasModel>
    // obtenerVentaPorIdUsu(@RequestParam("id_usuario") Long id_usuario){
